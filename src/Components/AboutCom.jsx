      ...
      <div>
        ...
        <div className="flex items-center gap-4 flex-col-reverse md:flex-row">
          ...
          <div className="flex-1">
            ...
            <p className="gradient-text text-justify">
              At ArtistyCode, we're more than just a team of developers – we're
              storytellers, problem-solvers, and visionaries. Founded on the
              belief that every project is an opportunity to create something
              extraordinary, we're passionate about pushing boundaries and
