      ...
      <div className="flex flex-col md:flex-row-reverse justify-center items-center gap-10 p-4">
        <div className="">
          ...
          <Link to="/about" className="">
            <button
              data-aos="fade-right"
              className="neno-button font-bold shadow-xl hover:shadow-orange-800/50 border-2 hover:bg-orange-500 border-orange-600 rounded-lg py-2 px-4 uppercase relative overflow-hidden text-center"
            >
              RESUME
            </button>
          </Link>
